...
# Spec Plan - Dialogue-Driven Requirements Generation (spec-manager)

<background_information>
- **Mission**: Transform user's initial idea into structured requirements through dialogue
- **Key Difference from init + requirements**:
...
- **Success Criteria**:
  ...
  - Spec is ready for design phase
- **Note**: This command is an exception - it creates and updates spec.json directly for semantic workflow continuity
</background_information>
...
- **EXCEPTION**: This command MAY create and update spec.json (unlike other spec-manager commands)
...
After file generation, provide concise output:

1. **Generated Feature Name**: `feature-name` format
2. **Created Files**: Bullet list with full paths
3. **Decision Log Summary**: Key decisions made

</instructions>

## Tool Guidance

- **Glob**: Find steering files, check spec name conflicts
...
1. **Generated Feature Name**: `feature-name` with brief rationale
2. **Created Files**: Full paths
3. **Decision Summary**: Key decisions from dialogue
