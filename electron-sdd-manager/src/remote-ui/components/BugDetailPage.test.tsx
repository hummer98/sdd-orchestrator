...
describe('BugDetailPage', () => {
  ...
  // =============================================================================
  // Task 8.2: Mobile版：MobilePullToRefreshでラップ (BugDetailPage)
  // Requirements: 5.3 (BugDetailPageでPull to Refresh操作)
  // Method: MobilePullToRefresh
  // =============================================================================

  describe('MobilePullToRefresh integration (Req 5.3, Task 8.2)', () => {
    it('should render MobilePullToRefresh wrapper on mobile when onRefresh is provided', async () => {
      ...
      expect(screen.getByTestId('bug-pull-to-refresh')).toBeInTheDocument();
    });
    ...
    it('should not render MobilePullToRefresh on desktop', async () => {
      ...
      expect(screen.queryByTestId('bug-pull-to-refresh')).not.toBeInTheDocument();
    });
    ...
    it('should pass isRefreshing prop to MobilePullToRefresh', async () => {
      ...
      expect(screen.getByTestId('bug-pull-to-refresh-indicator')).toBeInTheDocument();
    });
  ...
  // =============================================================================
  // Task 8.3: Desktop版：RefreshButtonを追加 (BugDetailPage)
  // Requirements: 6.3 (BugDetailPageにリフレッシュボタン表示), 6.4 (クリック時に再取得)
  // Method: RefreshButton
  // =============================================================================

  describe('RefreshButton integration (Req 6.3, 6.4, Task 8.3)', () => {
    it('should render RefreshButton on desktop when onRefresh is provided', async () => {
      ...
      expect(screen.getByTestId('bug-refresh-button')).toBeInTheDocument();
    });
    ...
    it('should not render RefreshButton on mobile', async () => {
      ...
      expect(screen.queryByTestId('bug-refresh-button')).not.toBeInTheDocument();
    });
    ...
    it('should call onRefresh when RefreshButton is clicked (Req 6.4)', async () => {
      ...
      const refreshButton = screen.getByTestId('bug-refresh-button');
