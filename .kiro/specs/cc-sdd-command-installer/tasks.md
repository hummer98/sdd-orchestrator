...
- [ ] 2. spec-managerテンプレートへのdocument-reviewコマンド追加
- [ ] 2.1 spec-manager用document-reviewコマンドを作成
...
- [ ] 3. CLAUDE.mdテンプレートの準備
- [ ] 3.1 cc-sddワークフロー用CLAUDE.mdテンプレートを作成
  - `resources/templates/CLAUDE.md`にcc-sddワークフローセクションを含むテンプレートを配置
  - 新規プロジェクトへのインストール時に使用される基本テンプレート
  - _Requirements: 4.1_

- [ ] 4. CcSddWorkflowInstallerサービスの実装
- [ ] 4.1 CcSddWorkflowInstallerクラスの基本構造を実装
