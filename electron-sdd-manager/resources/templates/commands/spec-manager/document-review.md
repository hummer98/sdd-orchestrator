...
- Verify `spec-manager/specs/$0/` exists
- Verify at least one of the following exists:
  - `spec-manager/specs/$0/requirements.md`
  - `spec-manager/specs/$0/design.md`
  - `spec-manager/specs/$0/tasks.md`
...
Collect all `.md` and `.json` files from `spec-manager/specs/$0/` directory:
...
- Tasks mention "create new" for refactoring without corresponding "delete" tasks
...
1. Search for `document-review-*.md` files in `spec-manager/specs/$0/`
2. Get maximum existing review number
3. Determine next sequential number (start with `1` if none exist)

Report file: `spec-manager/specs/$0/document-review-{n}.md`
...
1. **Report Location**: `spec-manager/specs/$0/document-review-{n}.md`
