...
// trpc-full-migration Task 5.3: Use tRPC vanilla client for bug operations
...
export function CreateBugDialog({ isOpen, onClose }: CreateBugDialogProps): React.ReactElement | null {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      // trpc-full-migration Task 5.3: Use tRPC for executeBugCreate
      // trpc-full-migration: Cast to AgentInfo (tRPC infers wider AgentStatus from server-side type)
      const agentInfo = await getVanillaClient().bug.executeBugCreate.mutate({
        projectPath: currentProject,
        description: trimmedDescription,
        worktreeMode: useWorktree,
      }) as unknown as AgentInfo;  // tRPC infers wider AgentStatus from server-side type
