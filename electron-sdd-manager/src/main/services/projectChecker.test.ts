...
// unified-tool-path-resolver: Tool Availability Check tests removed
// checkJqAvailability and checkJjAvailability methods are now handled by ToolPathResolverService
// See toolPathResolverService.test.ts for the new tests
