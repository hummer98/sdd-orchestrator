/**
 * MobileSpecWorkflowView Component
 *
 * **Mobile版専用** - Spec詳細・Phase実行UI
 *
 * Desktop版ではSpecActionsView（右サイドバー）が同等の機能を提供するため、
 * このコンポーネントはMobile版のMobileLayoutでのみ使用される。
 *
...
export interface MobileSpecWorkflowViewProps {
...
export function MobileSpecWorkflowView({
  spec,
  apiClient,
  onPhaseExecuted,
  onApprovalUpdated,
}: MobileSpecWorkflowViewProps): React.ReactElement {
  // State
    ...
    <div data-testid="remote-spec-detail" className="flex flex-col h-full overflow-y-auto">
      ...
      <div className="flex-shrink-0 p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between">
          ...
          {/* Auto Execute / Convert buttons moved to RightSidebar WorkflowFooter */}
        </div>
      </div>
...
export default MobileSpecWorkflowView;
