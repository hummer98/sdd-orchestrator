 ...
 * trpc-full-migration Task 11.2: ipc/listDocsFilesCore.test.ts から trpc/__tests__/ に移動
 *
...
// Import after mock setup - updated path from ipc/projectFileUtils to trpc/helpers/projectFileUtils
import { listDocsFilesCore } from '../helpers/projectFileUtils';
