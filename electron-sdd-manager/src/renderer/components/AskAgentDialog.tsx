...
/**
 * AskAgentDialog - Dialog for executing custom prompts
 * - Prompt input textarea
 * - Execute/Cancel buttons
 * - Displays agent type (Project/Spec)
...
export function AskAgentDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" data-testid="ask-agent-dialog">
      {/* Backdrop */}
      <div
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-md text-sm text-gray-600 dark:text-gray-400">
            {isProjectAgent ? (
              <p>Steering files (`.kiro/steering/*.md`) をコンテキストとして使用します。</p>
            ) : (
              <p>Steering files と Spec files (`.kiro/specs/{specName}/*.md`) をコンテキストとして使用します。</p>
            )}
          </div>
